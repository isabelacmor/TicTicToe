 ...
 *	Class: COP 3330 - Summer 2013
 *	Title: Program 4: TicTacToe Game
 *	Date : 07/10/2013
 *
 *	Description: TicTacToe game (Human vs Human and Human vs AI)
 *				 implemented with GUI
 *
 *  File	   : Create the GUI for Human vs Human
 * 
 */
